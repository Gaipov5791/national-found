  ...
  return (
    <div ref={rootRef} className="relative" style={{ height: "4100px" }}>
      ...
      >
        ...
        {/* BRAND TITLE — starts huge center, scrubs into Navbar slot */}
        <div
          ref={brandRef}
          className="pointer-events-none absolute left-1/2 top-[34%] z-40 -translate-x-1/2 -translate-y-1/2 will-change-transform"
          style={{ transformOrigin: "50% 50%" }}
        >
          <div className="text-center font-display font-semibold leading-[1.05] tracking-[0.02em] text-[color:var(--ink)] text-[clamp(2.4rem,6.2vw,5.2rem)] drop-shadow-[0_4px_30px_rgba(255,255,255,0.55)]">
