...
export function HeroScrollHint({ hintRef, onClick }: HeroScrollHintProps) {
  ...
  return (
    ...
    >
      ...
      <span className="flex h-16 w-16 items-center justify-center rounded-full border-2 border-white/45 bg-black/20 shadow-[0_0_0_1px_rgba(0,0,0,0.15)] backdrop-blur-[2px] sm:h-20 sm:w-20">
